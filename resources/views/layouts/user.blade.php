                ...
                @else
                    <div class="text-center mt-6">
                        ...
                        <div class="flex justify-center items-center">
                            <a href="{{ url('/produk') }}">
                                <button type="button"
                                    class="text-white text-lg font-semibold bg-green-500 hover:bg-green-600 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-3 py-2 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800">Lihat Produk</button>
                            </a>
                        </div>
                    </div>

...
@section('content')
    ...
    <div class=" w-full flex justify-center items-center"
        style="padding: 70px 0px; background-color: #f6f6f6;">
                ...
                <div class="flex flex-col justify-between p-4 leading-normal md:w-1/2 w-full">
                    ...
                    <div class="flex flex-wrap justify-start items-center mt-2">
                        <button type="button"
                            ...
                            data-modal-target="buyNow-modal" data-modal-toggle="buyNow-modal">Pesan Sekarang</button>
                        <button type="button"
    ...
    <div id="buyNow-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            <!-- Modal content -->
            <form action="{{ route('transaction.start.now', ['id' => $product->id]) }}" method="POST" class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                @csrf
                <!-- Modal header -->
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white flex justify-center items-center gap-1">
                        <img src="{{ asset('assets/LF_logo.png') }}" alt="little florist" class="w-14"> <span>Little
                            Florist</span>
                    </h3>
                    <button type="button"
                    ...
                    <div class="flex justify-center items-center w-auto h-auto">
                        ...
                        <div class="w-auto h-auto">
                            ...
                            <div class="relative flex items-center max-w-[8rem]">
                                ...
                                <input type="text" id="{{ $product->slug }}" data-input-counter value="1"
                                    name="sold" aria-describedby="helper-text-explanation"
                ...
                <div
                    ...
                    <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Pesan
                        Sekarang</button>
                </div>
            </form>
        </div>

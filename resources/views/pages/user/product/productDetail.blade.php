                ...
                <div class="flex flex-col justify-between p-4 leading-normal md:w-1/2 w-full">
                    ...
                    <div class="flex flex-wrap justify-start items-center mt-2">
                                            ...
                                            <div class="flex justify-center items-center gap-2 w-auto h-auto">
                                                ...
                                                <div class="w-auto h-auto">
                                                    ...
                                                    <div class="relative flex items-center max-w-[8rem]">
                                                        ...
                                                        <input type="text" id="{{ $product->slug }}" data-input-counter
                                                            value="1" name="sold"
                        ...
                        @else
                            <a href="{{ url('/login') }}">
                                <button type="button"
                                class="button-buy text-lg font-semibold font-medium rounded text-sm px-3 py-2 me-1 mb-2 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800">Pesan Sekarang</button>
                            </a>
                            <a href="{{ url('/login') }}">
                                <button type="button"
                                class="button-cart text-lg font-semibold font-medium rounded text-sm px-3 py-2 me-1 mb-2 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800">Add To Cart</button>
                            </a>
                        @endif
                    </div>

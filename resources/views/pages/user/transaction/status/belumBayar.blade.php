                ...
                @if (!in_array($item->code, $lala))
                    ...
                    <div class="flex flex-wrap w-full justify-between items-center mb-2" style="margin-top: 25px;">
                        ...
                        @if (Auth::user()->role == 'Admin')
                            <div class="">
                                <button type="button"
                                    class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-semibold rounded-lg text-sm px-3 py-2 text-center" data-modal-target="accept-modal" data-modal-toggle="accept-modal">Accept</button>
                                <button type="button"
                                    class="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-semibold rounded-lg text-sm px-3 py-2 text-center">Hapus</button>
                                <!-- Main modal -->
                                    ...
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-4 md:p-5">
                                                <form class="space-y-4" action="{{ route('transaction.process', ['code' => $item->code]) }}" method="POST">
                                                    @csrf
                                                    <div>
                                                        <label for="email"
